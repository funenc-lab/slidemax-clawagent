...
require_text "$WORKSPACE_DIR/AGENTS.md" 'delivery-manifest.json' 'AGENTS.md'
require_text "$WORKSPACE_DIR/TOOLS.md" 'scripts/check_final_delivery_gate.sh' 'TOOLS.md'
require_text "$WORKSPACE_DIR/TOOLS.md" '--manifest /absolute/path/to/delivery-manifest.json' 'TOOLS.md'
